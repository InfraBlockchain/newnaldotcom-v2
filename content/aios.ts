export const aiosContent = {
  ...
  myData: {
    ...
    standards: [
      ...
      { name: "Audit", text: "Track who used the data, when, where, and for what purpose." },
      { name: "Traceability", text: "Understand which data contributed to which AI outcome." },
    ],
  },
  aiInterface: {
    headline1: "Pillar 2",
  ...
  founder: {
    ...
    links: [
      ...
      { label: "Read the Whitepapers", href: "#ip-whitepapers" },
    ],
  },
  ip: {
